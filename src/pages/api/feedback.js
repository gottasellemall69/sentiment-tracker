...
export default async function handler( req, res ) {
  if ( req.method === 'POST' ) {
    try {
      ...
      // Parse request body
      const { feedback, recaptchaToken, politicalSpectrum, predictedSpectrum, timestamp, source, confidence } = req.body;
      ...
      const document = {
        ...
        politicalSpectrum: politicalSpectrum?.trim() || predictedSpectrum || spectrumAnalysis.spectrum,
